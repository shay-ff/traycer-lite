...
import { generateStepExecutionPrompt, validateStepExecutionContext, sanitizeInput } from '@/utils/prompts';
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      const stepExecution: StepExecution = parseStepExecutionResponse(aiResponse);
